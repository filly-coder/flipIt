		...
		<div class="col-xl-12 layout-section">
			<div class="row row-featured row-featured-category">
				<div class="col-md-6"><img
							src="https://images.unsplash.com/photo-1553907987-1cf7501f15bc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80">
				</div>
				<div class="col-md-6">
					<h2>This is Joe</h2>
					<p>Joe posted is couch on craigslist</p>
					<p>His first offer was from a scammer</p>
					<p>His second offer was half his asking price</p>
				</div>
			</div>
		</div>
	</div>
