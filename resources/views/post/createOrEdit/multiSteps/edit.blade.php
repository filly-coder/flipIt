							...
							<div class="col-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<input name="post_type_id" value="{{ $post->post_type_id }}" type="hidden">
										...
										<div id="priceBloc" class="form-group row required">
											<label class="col-md-3 col-form-label" for="price">Lowest Asking Price</label>
											<div class="input-group col-md-8">
												<div class="input-group-prepend">
													<span class="input-group-text">{!! config('currency')['symbol'] !!}</span>
												</div>
												...
												<input id="low_price"
													   ...
													   placeholder="{{ t('e.i. 15000') }}"
													   type="text"
													   value="{{ \App\Helpers\Number::toFloat(old('price', $post->low_price)) }}"
												>
